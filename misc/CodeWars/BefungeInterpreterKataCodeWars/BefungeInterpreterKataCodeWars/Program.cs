...
namespace BefungeInterpreterKataCodeWars
{
    class Program
    {
        static string[][] tests = 
        {
            ...
            new string[] { "01->1# +# :# 0# g# ,# :# 5# 8# *# 4# +# -# _@", "01->1# +# :# 0# g# ,# :# 5# 8# *# 4# +# -# _@"},
            new string[] {"0 v\n \"<@_ #! #: #,<*2-1*92,*84,*25,+*92*4*55.0", "0 v\n \"<@_ #! #: #,<*2-1*92,*84,*25,+*92*4*55.0"},
            new string[] { "<>>#;>:#,_@;\"Hello, world!\"", "Hello, world!"}, // Befunge 98
            new string[] { ";Hello, world!; >00ga6*1-->#@_1>:#<>#<0#<g#<:#<a#<6#<*#<1#<-#<-#<>#+>#1>#,_$$@", "Hello, world!"}, // Befunge 98
            new string[] { "5 :>>#;1-:48*+01p*01g48*-#;1#+-#1:#<_$.@", "120"}, // Befunge 98
